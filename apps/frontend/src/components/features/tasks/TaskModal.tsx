...
export function TaskModal({ isOpen, onClose, task, initialStatus }: TaskModalProps) {
  ...
  return (
    ...
    >
      {task && (
        <div className="flex border-b mb-4 overflow-x-auto -mx-4 sm:mx-0 px-4 sm:px-0">
          <button
            onClick={() => setActiveTab('details')}
            className={clsx(
              'px-3 sm:px-4 py-2 text-sm sm:text-base font-medium transition-colors whitespace-nowrap',
              activeTab === 'details'
